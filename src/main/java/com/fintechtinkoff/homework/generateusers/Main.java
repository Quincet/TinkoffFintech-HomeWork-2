...
import com.fintechtinkoff.homework.generateusers.factory.HumanDataBaseFactory;
import com.fintechtinkoff.homework.generateusers.factory.HumanManualFactory;
import com.fintechtinkoff.homework.generateusers.factory.HumanWebFactory;
import com.fintechtinkoff.homework.generateusers.factory.IHumanFactory;
import com.fintechtinkoff.homework.generateusers.human.Human;
import com.fintechtinkoff.homework.generateusers.writers.DataBaseWriter;
import com.fintechtinkoff.homework.generateusers.writers.ExcelWriter;
import com.fintechtinkoff.homework.generateusers.writers.Pdf_Writer;
